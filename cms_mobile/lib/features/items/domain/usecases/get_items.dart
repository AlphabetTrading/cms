...
class GetItemsUseCase implements UseCase<List<WarehouseItemEntity>, GetItemsInputEntity?> {
  final ItemRepository repository;

  GetItemsUseCase(this.repository);

  @override
  Future<DataState<List<WarehouseItemEntity>>> call({GetItemsInputEntity? params}) {
