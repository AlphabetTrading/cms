...
class MaterialTransferBloc extends Bloc<MaterialTransferEvent, MaterialTransferState> {
  ...
  MaterialTransferBloc(this._materialTransferUseCase,
      this._createMaterialTransferUseCase, this._getMaterialTransferDetailsUseCase)
  ...
  void onCreateMaterialTransfer(
      CreateMaterialTransferEvent event, Emitter<MaterialTransferState> emit) async {
