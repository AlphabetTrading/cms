...
class ProformaMainFormCubit extends Cubit<ProformaMainFormState> {
  ProformaMainFormCubit({
    String? materialRequestId,
    String? materialId,
  }) : super(ProformaMainFormState(
...
class ProformaItemFormCubit extends Cubit<ProformaItemFormState> {
  ProformaItemFormCubit({
    String? vendor,
    double? price,
    String? photo,
    String? remark,
  }) : super(ProformaItemFormState(
