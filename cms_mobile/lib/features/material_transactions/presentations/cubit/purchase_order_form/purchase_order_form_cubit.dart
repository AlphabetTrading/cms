...
class PurchaseOrderWarehouseFormCubit
    extends Cubit<PurchaseOrderWarehouseFormState> {
  PurchaseOrderWarehouseFormCubit({
    String? warehouseId,
  }) : super(PurchaseOrderWarehouseFormState(
  ...
  // @override
  // void onChange(Change<PurchaseOrderFormState> change) {
