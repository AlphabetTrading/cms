...
class MaterialTransferWarehouseFormState extends Equatable {
  final WarehouseDropdown warehouseDropdown;
  final bool isValid;

  const MaterialTransferWarehouseFormState(
      {this.warehouseDropdown = const WarehouseDropdown.pure(),
      this.isValid = false});

  MaterialTransferWarehouseFormState copyWith({
    WarehouseDropdown? warehouseDropdown,
    bool? isValid,
  }) {
    return MaterialTransferWarehouseFormState(
...
class MaterialTransferFormState extends Equatable {
  final bool isValid;
