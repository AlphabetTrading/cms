...
class MaterialTransferWarehouseFormCubit
    extends Cubit<MaterialTransferWarehouseFormState> {
  MaterialTransferWarehouseFormCubit({
    String? warehouseId,
  }) : super(MaterialTransferWarehouseFormState(
  ...
  // @override
  // void onChange(Change<MaterialTransferFormState> change) {
  //   super.onChange(change);
  //   print('Current State: ${change.currentState}');
  //   print('Next State: ${change.nextState}');
  // }

  // MaterialTransferFormState copyWith({
  //   bool? isValid,
  //   FormStatus? formStatus,
  //   QuantityField? quantityField,
  // }) {
  //   return MaterialTransferFormState(
...
class MaterialTransferFormCubit extends Cubit<MaterialTransferFormState> {
  MaterialTransferFormCubit({
    String? materialId,
    // String? warehouseId,
    double? quantity,
    ...
    double? inStock,
    String? remark,
  }) : super(MaterialTransferFormState(
