...
class CreateMaterialTransferForm extends StatefulWidget {
  final bool isEdit;
  final int index;
  ...
  @override
  State<CreateMaterialTransferForm> createState() =>
      _CreateMaterialTransferFormState();
}

class _CreateMaterialTransferFormState extends State<CreateMaterialTransferForm> {
  @override
  Widget build(BuildContext context) {
    final materialTransferFormCubit = context.watch<MaterialTransferFormCubit>();
    final quantityField = materialTransferFormCubit.state.quantityField;
    final materialDropdown = materialTransferFormCubit.state.materialDropdown;
    // final warehouseDropdown = materialTransferFormCubit.state.warehouseDropdown;
    final useTypeDropdown = materialTransferFormCubit.state.useTypeDropdown;
    final subStructureUseDropdown =
        materialTransferFormCubit.state.subStructureUseDropdown;
    final superStructureUseDropdown =
        materialTransferFormCubit.state.superStructureUseDropdown;

    // final unitDropdown = materialTransferFormCubit.state.unitDropdown;
    final remarkField = materialTransferFormCubit.state.remarkField;
                ...
                children: [
                  ...
                  CustomDropdown(
                    ...
                    onSelected: (dynamic value) {
                      materialTransferFormCubit.materialChanged(value);
                    },
                    ...
                    children: [
                      Flexible(
                        child: CustomTextFormField(
                          ...
                          onChanged: materialTransferFormCubit.quantityChanged,
                  ...
                  CustomDropdown(
                    ...
                    onSelected: (dynamic value) =>
                        materialTransferFormCubit.useTypeChanged(value),
                  ...
                  useTypeDropdown.value == UseType.SUB_STRUCTURE
                      ? CustomDropdown(
                          initialSelection: subStructureUseDropdown.value !=
                              ...
                              : null,
                          onSelected: (dynamic value) => materialTransferFormCubit
                  ...
                  CustomTextFormField(
                    ...
                    maxLines: 3,
                    onChanged: materialTransferFormCubit.remarkChanged,
                  ...
                  ElevatedButton(
                    onPressed: () {
                      materialTransferFormCubit.onSubmit();
                      if (materialTransferFormCubit.state.isValid) {
                        if (widget.isEdit) {
                          // final updated = MaterialTransferEntity(
                          ...
                          // BlocProvider.of<MaterialTransferLocalBloc>(context).add(
                          //     EditMaterialTransferMaterialLocal(
                          //         updated, widget.index));
                        } else {
                          // BlocProvider.of<MaterialTransferLocalBloc>(context).add(
                          //   AddMaterialTransferMaterialLocal(
